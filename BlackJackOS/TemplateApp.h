 ...
 * Quick checklist
 * ───────────────
 *  [x] Rename the class  (search/replace "TemplateApp")
...
public:
    ...
    void onLaunch() override {
        ...
        lv_obj_t* content = lv_label_create(_screen);
        lv_label_set_text(content, "Put your app content here.");
        lv_obj_set_style_text_color(content, lv_color_hex(0xE0E0E0), LV_PART_MAIN);
